...
function s.initial_effect(c)
	local e1=Ritual.AddProcGreaterCode(c,s.ritualfil,1,s.extrafil,s.extraop,s.forcedgroup,s.stage2)
	--salvage
...
s.fit_monster={77777015}
function s.ritualfil(c)
	return c:IsCode(77777015) and c:IsRitualMonster()
end
