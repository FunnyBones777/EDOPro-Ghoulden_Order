...
s.fit_monster={77777037} --should be removed in hardcode overhaul
s.listed_names={77777037}
...
function s.repfilter(c,tp)
	return c:IsFaceup() and c:IsControler(tp) and c:IsLocation(LOCATION_MZONE) and c:IsCode(77777037)
